...
crates/qga-sim     realm worldgen, nebula ICs, OAM–flux PDE, Lorenz analog
...
make headless       # 8 offscreen cosmos frames
...
| Flag | What you see |
|------|----------------|
| `--scene lab` | Native Hopf-fiber explorer (Kingdom convention) |
| `--scene realm` | Mt. Shasta analogue: volcanic cone, snow, sequoia grove, ley-line fibers, 24 Hurwitz sanctuaries |
| `--scene cosmos` | Solar-nebula collapse: GPU N-body + flux-flywheel flattening. Optional six-species iris disk |
